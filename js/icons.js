...
const ICONS = {
  ...
  coin: makeSvg(`
    ...
    <path d="M15 9.5c0-1.5-1.3-2.5-3-2.5s-3 1-3 2.5 1.3 2 3 2.5 3 1 3 2.5-1.3 2.5-3 2.5-3-1-3-2.5"></path>
  `),
  ...
  factory: makeSvg(`
    ...
    <path d="M4 20V9l5 3V9l5 3V5l6 3v12"></path>
  `),
  ...
  bitcoin: makeSvg(`
    <circle cx="12" cy="12" r="10"></circle>
    <path d="M9.5 8h5a2.5 2.5 0 0 1 0 5h-5z"></path>
    <path d="M9.5 13h6a2.5 2.5 0 0 1 0 5h-6z"></path>
    <path d="M10 6v2"></path>
    <path d="M14 6v2"></path>
  ...
  atom: makeSvg(`
    ...
    <path d="M20.2 20.2c2.04-2.03.02-7.36-4.5-11.9C11.16 3.78 5.83 1.76 3.8 3.8c-2.04 2.03-.02 7.36 4.5 11.9 4.54 4.52 9.87 6.54 11.9 4.5z"></path>
  ...
  crown: makeSvg(`
    <path d="M2 18h20l-2-8-5 4-3-6-3 6-5-4z"></path>
  `),
